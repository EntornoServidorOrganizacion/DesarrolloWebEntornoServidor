...
public class FormularioSimple extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response, boolean correcto)
        ...
        try {
            ...
            out.println("<a href='./index.html'>Menú</a></br>");
            ...
            if (!correcto) {
                ...
                while (parametros.hasMoreElements()) {
                    String nombre = parametros.nextElement(); //en esta variable vamos añadiendo todos las labels del formulario, y cuando no haya más, pasará al if
